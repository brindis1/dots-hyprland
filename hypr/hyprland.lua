...
-- Default springs
hl.curve("easy", { type = "spring", mass = 0.51, stiffness = 890.2633, dampening = 42.8273644 })
...
hl.animation({ leaf = "layersIn", enabled = true, speed = 1.5, bezier = "easeOutQuint", style = "slide" })
...
local screenshot_anim = hl.layer_rule({
	match = { namespace = "grim"},
	no_anim = true,
})

local screenshot_anim1 = hl.layer_rule({
